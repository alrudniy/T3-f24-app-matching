...
import {button, container, image, modal_error, text} from "../styles";
import {Ionicons} from "@expo/vector-icons";
import {authRegisterPost} from "@/client"; // Importing Ionicons for the toggle icon
...
export default function AccountCreationView() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const {data, error} = await authRegisterPost({
                body: {
                    username,
                    email,
