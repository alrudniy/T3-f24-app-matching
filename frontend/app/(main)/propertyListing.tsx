...
import {propertiesPropertyEditIntPropertyIdPut, usersApiCurrentUserGet, usersApiUserIntUserIdGet} from "@/client";
...
export default function PropertyListing() {
    ...
    const fetchUserProfileById = async (userId: number) => {
        ...
        const {data, error} = await usersApiUserIntUserIdGet({
            path: {
                user_id: userId
            }
        })
    ...
    const handleSaveChanges = async () => {
        ...
        const {data, error} = await propertiesPropertyEditIntPropertyIdPut({
            path: {
                property_id: Number(propertyId)
            },
            body: {
                name: updatedProperty.name,
                price: String(updatedProperty.price),
                bedrooms: String(updatedProperty.bedrooms),
                bathrooms: String(updatedProperty.bathrooms),
                street_address: updatedProperty.street_address,
    ...
    return (
        <SafeAreaProvider>
            ...
            <View style={container.loggedInHeader}>
                ...
                <Image source={require("./(home)/assets/images/icon_logo.png")} style={image.loggedInLogo}
                       resizeMode="contain"/>
                        ...
                        <ScrollView contentContainerStyle={styles.scrollContent}>
                            ...
                            <View style={styles.editContainer}>
                                ...
                                <TextInput
                                    ...
                                    onChangeText={(text) => setUpdatedProperty({
                                        ...updatedProperty!,
                                    ...
                                    <View style={styles.listedByCard}>
                                        <View style={styles.listedByLeft}>
                                            {userProfile.profile_picture ? (
                                                <Image source={{uri: userProfile.profile_picture}}
            ...
            <View style={container.navBar}>
                ...
                <TouchableOpacity style={[container.navBarItem]}
