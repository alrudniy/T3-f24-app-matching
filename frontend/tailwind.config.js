  ...
  theme: {
    extend: {
      ...
      fontFamily:{ //3 font families, Poppings, Roboto, and Nunito, for some options
        ...
        robreg:["Roboto-Regular","sans-serif"],
        robmed:["Roboto-Medium","sans-serif"],
        robbold:["Roboto-Bold","sans-serif"],
        robblack:["Roboto-Black","sans-serif"],
        nunxlight:["Nunito-ExtraLight","sans-serif"],
        nunlight: ["Nunito-Light","sans-serif"],
        nunreg: ["Nunito-Regular","sans-serif"],
        nunmed: ["Nunito-Medium","sans-serif"],
        nunsemb: ["Nunito-SemiBold","sans-serif"],
        nunb: ["Nunito-Bold","sans-serif"],
        nunxb: ["Nunito-ExtraBold","sans-serif"],
        nunbl: ["Nunito-Black","sans-serif"],
